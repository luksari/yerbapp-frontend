import {
  OptionTypeBase, SelectComponentsConfig, FormatOptionLabelMeta, OptionsType, MenuPlacement, MenuPosition, FocusEventHandler, ValueType, ActionMeta, InputActionMeta, KeyboardEventHandler, GroupedOptionsType, StylesConfig,
} from 'react-select';
...
/**
 * It has been copied from @look Select.d.ts which was named Props,
 * needed to do this in order to fix problem in @look FormField.tsx
 * infered type named R failed to keep typings from ReactSelect because of
 * interface Props was extending @look SelectComponentsProps which was { [key in string]: any };
 * So in order to fix typings from library when infering types from Component I had to remove extends SelectComponentsProps
 */
export interface FixedSelectProps<OptionType extends OptionTypeBase = Option> {
